	...
	Anaya_Primaria_2022_DevStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Título 17', element: 'h3', attributes: { 'class': 'bck-title-17'} },
				{ name: 'Título 18', element: 'h3', attributes: { 'class': 'bck-title-18'} },
				{ name: 'Título 19', element: 'h3', attributes: { 'class': 'bck-title-19'} },
				{ name: 'Título 20', element: 'h3', attributes: { 'class': 'bck-title-20'} },
				{ name: 'Título 21', element: 'h3', attributes: { 'class': 'bck-title-21'} },
				...
				{ name: 'Cell 08', element: 'td', attributes: { 'class': 'bck-td bck-td-8'} },
				{ name: 'Cell 09', element: 'td', attributes: { 'class': 'bck-td bck-td-9'} },
				{ name: 'Cell 10', element: 'td', attributes: { 'class': 'bck-td bck-td-10'} },
				...
				{ name: 'Desplegable 6', type: 'widget', widget: 'blink_dropdown', attributes: { 'class': 'bck-dropdown bck-dropdown-6' } },
				{ name: 'Desplegable 7', type: 'widget', widget: 'blink_dropdown', attributes: { 'class': 'bck-dropdown bck-dropdown-7' } },
				{ name: 'Desplegable 8', type: 'widget', widget: 'blink_dropdown', attributes: { 'class': 'bck-dropdown bck-dropdown-8' } },
				{ name: 'Desplegable 9', type: 'widget', widget: 'blink_dropdown', attributes: { 'class': 'bck-dropdown bck-dropdown-9' } },
