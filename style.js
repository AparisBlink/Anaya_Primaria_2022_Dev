	...
	Anaya_Primaria_2022_DevStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Ol.06.123 Color 1', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-6' } },
				{ name: 'Ol.07.123 Color 2', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-7' } },
				{ name: 'Ol.08.abc ACT Paréntesis', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-8' } },
