	...
	Anaya_Secundaria_2022_DevStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'E.11', element: 'span', attributes: { 'class': 'bck-enfasis-11'} },
				{ name: 'E.12', element: 'span', attributes: { 'class': 'bck-enfasis-12'} },
				{ name: 'E.13', element: 'span', attributes: { 'class': 'bck-enfasis-13'} },
				...
				{ name: 'Icono Speaking', element: 'span', attributes: { 'class': 'icon icon_speaking' } },
				{ name: 'Icono TIC', element: 'span', attributes: { 'class': 'icon icon_tic' } },
				{ name: 'Icono Writing', element: 'span', attributes: { 'class': 'icon icon_writing' } },
