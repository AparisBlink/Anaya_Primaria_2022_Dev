	...
	Anaya_Primaria_2022_DevStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: ' T.15', element: 'h3', attributes: { 'class': 'bck-title-15'} },
				{ name: ' T.16', element: 'h3', attributes: { 'class': 'bck-title-16'} },
				...
				{ name: 'Ol.08', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-8' } },
				{ name: 'Ol.09', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-9' } },
				{ name: 'Ol.10', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-10' } },
				{ name: 'Ol.11', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-11' } },
				{ name: 'Ol.12', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-12' } },
				{ name: 'Ol.13', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-13' } },
				{ name: 'Ol.14', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-14' } },
				{ name: 'Ol.15', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-15' } },
				...
				{ name: 'L.Des.03', element: 'ul', attributes: { 'class': 'bck-ul bck-ul-3' } },
				{ name: 'L.Des.04', element: 'ul', attributes: { 'class': 'bck-ul bck-ul-4' } },
